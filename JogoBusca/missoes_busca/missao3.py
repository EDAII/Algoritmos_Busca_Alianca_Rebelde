...
class Missao3:
    ...
    def iniciar_missao_contexto(self):
        ...
        tk.Label(
            ...
            text="Missão 3: Sintonizando a Frequência Secreta",
        ...
        contexto = (
            "Fulcrum: \"Interceptamos uma transmissão Imperial, mas a frequência está oculta em um espectro de canais distribuídos uniformemente. "
            "A forma mais rápida de encontrá-la é usando o algoritmo de **busca por interpolação**.\""
        )
